...
int main(){
    ...
    const char *s = "BBC ABCDAB ABCDABCDAABCDABBC ABCDAB ABCDABBC ABCDAB ABCDABCDAABCDABCDAABCDABCEABBC ABCDAB ABCDABCDAABCDADSFGEGBDABCDABCEADSFGEGEABCAB";
    const char *p = "AAAAA";
    ...
    finish = clock();
    duration = (double)(finish - start) / CLOCKS_PER_SEC/1000000.0;
    printf( "violent cost %.10f seconds\n", duration );
